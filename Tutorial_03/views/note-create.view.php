...
<main>
    ...
    <form method="POST" class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <textarea id="note" name="note" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
